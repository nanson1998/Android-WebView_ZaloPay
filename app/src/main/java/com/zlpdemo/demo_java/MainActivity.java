...
import com.zlpdemo.demo_java.Api.CreateOrder;
import com.zlpdemo.demo_java.Constant.AppInfor;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnCreateOrder, btnPay, btnTowebview;
    EditText txtAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ZaloPay SDK Init
        ZaloPaySDK.init(AppInfor.APP_ID, Environment.SANDBOX);
        ...
        btnTowebview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("newIntent", "Open to WebView");
